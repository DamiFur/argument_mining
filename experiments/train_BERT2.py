...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    cached_features_file = "cached_{}_{}_{}".format(mode, "bert-large-cased", str(args.max_seq_length))
...
def main():
    ...
    parser.add_argument("--do_train", action="store_true",
                        help="Whether to run training.", default=True)
...
#    args.n_gpu = torch.cuda.device_count()
    ...
    labels = [s[1] for sent in getter.sentences for s in sent]
